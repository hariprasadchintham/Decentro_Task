...
class TestReqResAPI(unittest.TestCase):
    ...
    def setUp(self):
        self.results = {}  # Dictionary to store test case results
    ...
    def record_result(self, test_name, result):
    ...
    def test_get_user_list(self):
        ...
        self.record_result("test_get_user_list", True)
    ...
    def test_get_single_user(self):
        ...
        self.record_result("test_get_single_user", True)
    ...
    def test_create_user(self):
        ...
        self.record_result("test_create_user", True)
    ...
    def test_create_user_invalid_payload(self):
        ...
        self.record_result("test_create_user_invalid_payload", True)

    def test_create_user_missing_fields(self):
        user_payload = {'name': 'John Doe'}  # Incomplete payload without 'job' field
        response = requests.post(self.base_url, json=user_payload)
        self.assertNotEqual(response.status_code, 400)  # Expecting a status code other than 400
        self.record_result("test_create_user_missing_fields", True)
    ...
    def test_update_user(self):
        ...
        self.record_result("test_update_user", True)
    ...
    def test_update_user_invalid_id(self):
        ...
        self.record_result("test_update_user_invalid_id", True)
    ...
    def test_delete_user(self):
        ...
        self.record_result("test_delete_user", True)
    ...
    def test_get_nonexistent_user(self):
        ...
        self.record_result("test_get_nonexistent_user", True)
    ...
    def test_login_successful(self):
        ...
        self.record_result("test_login_successful", True)

    def test_login_unsuccessful(self):
        login_payload = {'email': 'peter@klaven'}
        response = requests.post('https://reqres.in/api/login', data=login_payload)
        self.assertEqual(response.status_code, 400)
        self.record_result("test_login_unsuccessful", True)
